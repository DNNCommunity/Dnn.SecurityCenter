...
What you are seeing in Visual Studio now is only some snippets to get you started until the full documentation is published, now that this is done, you can view the full documentation at [https://david-poindexter.github.io/Dnn.SecurityCenter](https://david-poindexter.github.io/Dnn.SecurityCenter/articles/git.html#documentation)
